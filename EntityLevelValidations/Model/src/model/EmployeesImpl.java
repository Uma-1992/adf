...
public class EmployeesImpl extends EntityImpl {
    ...
    /**
     * Gets the attribute value for ShopProfileCount, using the alias name ShopProfileCount.
     * @return the value of ShopProfileCount
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for ShopProfileCount.
     * @param value value to set the ShopProfileCount
     */
    ...
    /**
     * Gets the attribute value for NewEmail, using the alias name NewEmail.
    ...
    /**
     * Sets <code>value</code> as the attribute value for NewEmail.
     * @param value value to set the NewEmail
     */
