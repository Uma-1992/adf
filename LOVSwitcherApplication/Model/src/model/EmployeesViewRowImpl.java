...
public class EmployeesViewRowImpl extends ViewRowImpl {
    ...
    public static final int SHOPPROFILECOUNT = AttributesEnum.ShopProfileCount.index();
    public static final int VERSIONNO = AttributesEnum.Versionno.index();
    public static final int AGE = AttributesEnum.Age.index();
    public static final int NEWEMAIL = AttributesEnum.NewEmail.index();
    ...
    /**
     * Gets the attribute value for SHOP_PROFILE_COUNT using the alias name ShopProfileCount.
     * @return the SHOP_PROFILE_COUNT
     */
    public BigDecimal getShopProfileCount() {
        return (BigDecimal) getAttributeInternal(SHOPPROFILECOUNT);
    }

    /**
     * Sets <code>value</code> as attribute value for SHOP_PROFILE_COUNT using the alias name ShopProfileCount.
     * @param value value to set the SHOP_PROFILE_COUNT
     */
    public void setShopProfileCount(BigDecimal value) {
        setAttributeInternal(SHOPPROFILECOUNT, value);
    }
    ...
    /**
     * Sets <code>value</code> as attribute value for VERSIONNO using the alias name Versionno.
    ...
    /**
     * Sets <code>value</code> as attribute value for AGE using the alias name Age.
    ...
    /**
     * Gets the attribute value for NEW_EMAIL using the alias name NewEmail.
     * @return the NEW_EMAIL
     */
    public String getNewEmail() {
        return (String) getAttributeInternal(NEWEMAIL);
    }

    /**
     * Sets <code>value</code> as attribute value for NEW_EMAIL using the alias name NewEmail.
     * @param value value to set the NEW_EMAIL
     */
    public void setNewEmail(String value) {
        setAttributeInternal(NEWEMAIL, value);
    }
    ...
    public String getDepartmentLOVSwitcher() {
        ...
        if(getSalary() != null && getSalary().doubleValue() <= 5000){
            ...
            return"LOV_DepartmentIdGreterThan50";
        }
